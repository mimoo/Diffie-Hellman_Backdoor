...
Although the quest to find the Juniper's backdoor and the numerous open questions that arose from that work are a fascinating read by itself\footnote{\hreaf{http://eprint.iacr.org/2016/376}{Checkoway at al: A Systematic Analysis of the Juniper Dual EC Incident (2016)}} \cite{juniper}, it is only the introduction of this work that aims to show how secure and strong cryptographic constructions are a simple and subtle change away from being your own secretive pipe-show.\\
...
\bibitem{juniper} Checkoway at al \href{http://eprint.iacr.org/2016/376}{A Systematic Analysis of the Juniper Dual EC Incident (2016)}
