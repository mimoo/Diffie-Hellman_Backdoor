...
\todo{I should note that I can't use more than n=pq two primes, otherwise it gets too low and it's factorable, it should be treated like RSA}

\section{A Composite Modulus for a NOBUS Backdoor with a B-Smooth Order (CM-SO)}

p-1 B2 is 10^15 ~ 50bits number
so we need to use the large factor at 
