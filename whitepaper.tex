...
Computing the discrete logarithm of that value, we get $x \pmod{p_i^{k_i}}$. This works because of the following observation (note that $x$ can be written $x_1 + p_i^{k_i} x_2$ for some $x_1$ and $x_2$)\todo{maybe add a more mathematical way of saying that, division euclidienne de x, $x_1$ is in the range $0,x_2$}:
\begin{align*}
...
\bibitem{shumow-ferguson} Shumow and Ferguson - \href{http://rump2007.cr.yp.to/15-shumow.pdf}{On the Possibility of a Back Door in the NIST SP800-90 Dual Ec Prng} (at Crypto 2007)
...
\bibitem{surreptitiously} Schneier, Fredrikson, Kohno and Ristenpart - \href{https://eprint.iacr.org/2015/097.pdf}{Surreptitiously Weakening Cryptographic Systems}
